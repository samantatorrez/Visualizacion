$( document ).ready(function() {
    ...
    const BONUS = 10;
    var music = 'dont-stop-me-now-8-bit-tribute-to-queen-8-bit-universe.mp3';
    var crash = 'crash.mp3';
    var audio;
    ...
    function refresh(){
        if(enemyShowed){
            ...
            $("#enemy"+enemyShowed).removeClass("rotateImage");
            $("#enemy"+enemyShowed).removeClass("enemy");
        ...
        let carImg = carDiv.getElementsByTagName('img')[0];
        carImg.src = "car.png";
        carDiv.style.left="140px";
        carDiv.style.top="365px";

        resetScore();
        $("#container").removeClass("pause");
        $("#container").addClass("carrera");
        $("#start").hide();
        $("#car").removeClass("rotateImage");
    }
    ...
    /*Evento de girar coche */
    function rotateImg(id){
        let carDiv = document.getElementById(id);
        let carImg = carDiv.getElementsByTagName('img')[0];
        if(id=="car") {
            carImg.src = "crash.png";
        }
        carDiv.classList.add("rotateImage");
    }
    /*Evento de sonido */
    function playCrash() {
            crashEffect.play();
